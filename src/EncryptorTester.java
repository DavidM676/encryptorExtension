...
public class EncryptorTester {
    public static void main(String[] args) {
     ...
     /*   System.out.println("---- TESTING PART A ----");
        Encryptor encryptor1 = new Encryptor(3, 5, 0);
        ...
        Encryptor encryptor2 = new Encryptor(3, 5, 0);
        ...
        Encryptor encryptor3 = new Encryptor(4, 3, 0);
        ...
        Encryptor encryptor = new Encryptor(3, 4, 0);
